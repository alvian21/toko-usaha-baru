...
@section('isi')
  ...
  <div id="information" class="offset">
    <div class="col-12 narrow text-center">
      ...
      <p class="lead">Toko usaha baru yang berletak di jalan Raya Barat no.4 kecamatan Jatirogo kota Tuban ini menyediakan berbagai perlengkapan seperti pakaian pria wanita, anak anak, kain, korden, perlengkapan sholat, sprei, payung, bed cover, kaos kaki, kasur lipat serta kasur busa. Untuk memudahkan Anda dalam mencari alamat kami, toko kami berada di depan kantor SAMSAT kecamatan Jatirogo. Silahkan datang dan kunjungi toko kami untuk bisa mendapatkan penawaran yang menarik dari kami.</p>
      <div class="btn_info">
        <a class="btn button_info" onclick="window.location='catalog'">
          <p>Lihat Produk</p>
          </a>
      </div>
    </div>
