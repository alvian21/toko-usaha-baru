        ...
        <div class="row">
            <div class="col-md-6">
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix mb-20">
                        <div class="pull-left">
                            <h4 class="text-blue h4">Laporan Penjualan | Summary</h4>

                        </div>

                    </div>
                    <form action="{{ route('laporan.cetak.penjualan') }}" method="POST" target="_blank">
                        @csrf
            ...
            <div class="col-md-6">
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix mb-20">
                        <div class="pull-left">
                            <h4 class="text-blue h4">Laporan Penjualan | Detail</h4>

                        </div>

                    </div>
                    <form action="{{ route('laporan.cetakdetail.penjualan') }}" method="POST" target="_blank">
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-12 col-md-2 col-form-label">Transaksi</label>
                            <div class="col-sm-12 col-md-10">
