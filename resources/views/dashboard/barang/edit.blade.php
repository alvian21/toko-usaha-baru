        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form action="{{ 'update' }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control  @error('harga_beli') is-invalid @enderror" value="{{ $item->harga_beli }}"
                            name="harga_beli" type="number" placeholder="Harga">
                        @error('nama_barang')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control  @error('harga_jual') is-invalid @enderror" value="{{ $item->harga_jual }}"
                            name="harga_jual" type="number" placeholder="Harga">
                        @error('nama_barang')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
