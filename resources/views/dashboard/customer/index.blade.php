        ...
        <div class="pd-20 card-box mb-30">
            <div class="clearfix mb-20">
                ...
                <div class="pull-right">
                    <a href="{{route('customer.create')}}" class="btn btn-primary btn-sm scroll-click"
                        role="button">Tambah Customer</a>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            {{-- <button type="button"
                                        class="btn btn-danger deletedata" data-id="{{$item->id}}">Hapus</button> --}}
                        </td>
                    </tr>
                    @empty
