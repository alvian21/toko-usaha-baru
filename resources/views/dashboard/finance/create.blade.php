...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        <div class="pd-20 card-box mb-30">
            <div class="clearfix">
                <div class="pull-left">
                    <h4 class="text-blue h4">Tambah Master Keuangan</h4>
                </div>
            </div>
                ...
                <div class="form-group mt-3 row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control @error('nama_keuangan') is-invalid @enderror" type="text"
                            value="{{ old('nama_keuangan') }}" name="nama_keuangan" placeholder="Nama Keuangan">
                        @error('nama_keuangan')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control  @error('tgl_keuangan') is-invalid @enderror" name="tgl_keuangan"
                            type="date" value="{{ old('tgl_keuangan') }}" placeholder="Date">
                        @error('tgl_keuangan')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control  @error('bukti_dokumen') is-invalid @enderror" name="bukti_dokumen"
                            type="file" value="{{ old('bukti_dokumen') }}" placeholder="Nomor Hp">
                        @error('bukti_dokumen')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
